...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    sqlProjectOpened: "已打开项目 {name}",
    sqlProjectsOpened: "已打开项目 {name}，其余 {count} 个文件夹已加入项目列表",
    driverManager: "驱动管理",
  ...
  sqlFileTree: {
    ...
    projectName: "项目名称",
    boundConnection: "绑定连接",
    noBoundConnection: "不绑定连接",
    boundConnectionHint: "执行本项目中的 SQL 文件时，将默认使用此连接。",
    defaultSchema: "默认模式",
    defaultSchemaPlaceholder: "可选，例如 dbo",
    newSqlFile: "新建 SQL 文件",
    newFolder: "新建文件夹",
    newFolderDefault: "新建文件夹",
    rename: "重命名",
    delete: "删除",
    deleteConfirmFile: "确定将文件 {name} 移入回收站吗？",
    deleteConfirmFolder: "确定将文件夹 {name} 及其中的 {count} 个文件移入回收站吗？",
    deleteFailed: "删除失败：{message}",
    createFailed: "创建失败：{message}",
    renameFailed: "重命名失败：{message}",
    operationFailed: "操作失败：{message}",
    trustTitle: "信任此项目？",
    trustMessage: "项目 {name} 来自外部文件夹。打开或执行文件前，请确认你信任其内容。",
    trustConfirm: "信任并继续",
    executeFolder: "执行整个文件夹",
    executeFolderEmpty: "此文件夹中没有可执行的 SQL 文件",
    removeProject: "移除项目",
    removeProjectConfirm: "确定从列表中移除项目 {name} 吗？磁盘上的文件不会被删除。",
    revealActiveFile: "定位当前文件",
    noFileToReveal: "当前没有可定位的已打开 SQL 文件",
    unsavedChanges: "有未保存的更改",
    localHistory: "本地历史",
    localHistoryEmpty: "暂无历史快照",
    localHistorySelect: "选择一个快照以预览",
    localHistoryRestore: "还原",
    localHistoryRestoreConfirm: "确定还原到所选快照吗？还原前会先保存当前内容，可随时再次还原。",
    localHistoryRestored: "已还原",
    localHistoryRestoreFailed: "还原失败：{message}",
    localHistoryConflict: "文件已被外部修改，请刷新后重试",
  },
  diff: {
    title: "比较架构",
    source: "源数据库",
