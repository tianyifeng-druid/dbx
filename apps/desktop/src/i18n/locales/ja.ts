...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    sqlProjectOpened: "プロジェクト {name} を開きました",
    sqlProjectsOpened: "プロジェクト {name} を開きました。残りの {count} 個のフォルダーをプロジェクト一覧に追加しました",
  ...
  sqlFileTree: {
    ...
    closePanel: "閉じる",
    loading: "読み込み中...",
    noFolder: "フォルダをドラッグするか、プロジェクトを開くをクリックしてください",
    ...
    projectName: "プロジェクト名",
    boundConnection: "バインド接続",
    noBoundConnection: "接続をバインドしない",
    boundConnectionHint: "このプロジェクトの SQL ファイルを実行する際、デフォルトでこの接続を使用します。",
    defaultSchema: "デフォルトスキーマ",
    defaultSchemaPlaceholder: "任意（例：dbo）",
    newSqlFile: "新規 SQL ファイル",
    newFolder: "新規フォルダー",
    newFolderDefault: "新しいフォルダー",
    rename: "名前を変更",
    delete: "削除",
    deleteConfirmFile: "ファイル {name} をごみ箱に移動しますか？",
    deleteConfirmFolder: "フォルダー {name} とその中の {count} 個のファイルをすべてごみ箱に移動しますか？",
    ...
    trustMessage: "プロジェクト {name} は外部フォルダーから来ています。ファイルを開く・実行する前に、その内容を信頼できることを確認してください。",
    trustConfirm: "信頼して続行",
    executeFolder: "フォルダー全体を実行",
    executeFolderEmpty: "このフォルダーには実行可能な SQL ファイルがありません",
    removeProject: "プロジェクトを削除",
    removeProjectConfirm: "プロジェクト {name} をリストから削除しますか？ディスク上のファイルは削除されません。",
    revealActiveFile: "アクティブなファイルの位置を表示",
    noFileToReveal: "位置を表示できる開かれた SQL ファイルがありません",
    unsavedChanges: "未保存の変更があります",
    localHistory: "ローカル履歴",
    localHistoryEmpty: "履歴スナップショットはまだありません",
    localHistorySelect: "プレビューするスナップショットを選択してください",
    localHistoryRestore: "復元",
    localHistoryRestoreConfirm: "選択したスナップショットに復元しますか？復元前に現在の内容がスナップショットされるため、いつでも復元し直せます。",
    localHistoryRestored: "復元しました",
    localHistoryRestoreFailed: "復元に失敗しました：{message}",
    localHistoryConflict: "ファイルが外部で変更されました。更新してから再試行してください",
  },
  mqTopics: {
    title: "トピック管理",
