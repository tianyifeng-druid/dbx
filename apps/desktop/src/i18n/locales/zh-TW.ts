...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    sqlProjectOpened: "已開啟專案 {name}",
    sqlProjectsOpened: "已開啟專案 {name}，其餘 {count} 個資料夾已加入專案列表",
  ...
  sqlFileTree: {
    ...
    projectName: "專案名稱",
    boundConnection: "綁定連線",
    noBoundConnection: "不綁定連線",
    boundConnectionHint: "執行此專案中的 SQL 檔案時，將預設使用此連線。",
    defaultSchema: "預設結構描述",
    defaultSchemaPlaceholder: "選填，例如 dbo",
    newSqlFile: "新增 SQL 檔案",
    newFolder: "新增資料夾",
    newFolderDefault: "新增資料夾",
    rename: "重新命名",
    delete: "刪除",
    deleteConfirmFile: "確定將檔案 {name} 移入資源回收筒嗎？",
    deleteConfirmFolder: "確定將資料夾 {name} 及其中 {count} 個檔案移入資源回收筒嗎？",
    deleteFailed: "刪除失敗：{message}",
    createFailed: "建立失敗：{message}",
    renameFailed: "重新命名失敗：{message}",
    operationFailed: "操作失敗：{message}",
    trustTitle: "信任此專案？",
    trustMessage: "專案 {name} 來自外部資料夾。開啟或執行檔案前，請確認你信任其內容。",
    trustConfirm: "信任並繼續",
    executeFolder: "執行整個資料夾",
    executeFolderEmpty: "此資料夾中沒有可執行的 SQL 檔案",
    removeProject: "移除專案",
    removeProjectConfirm: "確定從列表中移除專案 {name} 嗎？磁碟上的檔案不會被刪除。",
    revealActiveFile: "定位目前檔案",
    noFileToReveal: "目前沒有可定位的已開啟 SQL 檔案",
    unsavedChanges: "有未儲存的變更",
    localHistory: "本機歷史",
    localHistoryEmpty: "尚無歷史快照",
    localHistorySelect: "選擇一個快照以預覽",
    localHistoryRestore: "還原",
    localHistoryRestoreConfirm: "確定還原到所選快照嗎？還原前會先儲存目前內容，可隨時再次還原。",
    localHistoryRestored: "已還原",
    localHistoryRestoreFailed: "還原失敗：{message}",
    localHistoryConflict: "檔案已被外部修改，請重新整理後重試",
  },
  mqTopics: {
    title: "主題管理",
