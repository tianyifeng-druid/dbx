...
export default withEnglishFallback({
  ...
  toolbar: {
    ...
    sqlProjectOpened: "Projeto {name} aberto",
    sqlProjectsOpened: "Projeto {name} aberto; {count} pastas adicionais adicionadas à lista de projetos",
  ...
  sqlFileTree: {
    ...
    closePanel: "Fechar",
    loading: "Carregando...",
    noFolder: "Arraste uma pasta aqui ou abra um projeto",
    ...
    boundConnection: "Conexão vinculada",
    noBoundConnection: "Sem conexão vinculada",
    boundConnectionHint: "Os arquivos SQL deste projeto usarão esta conexão por padrão ao serem executados.",
    defaultSchema: "Esquema padrão",
    defaultSchemaPlaceholder: "Opcional, ex. dbo",
    newSqlFile: "Novo arquivo SQL",
    newFolder: "Nova pasta",
    newFolderDefault: "Nova pasta",
    rename: "Renomear",
    delete: "Excluir",
    deleteConfirmFile: "Mover o arquivo {name} para a lixeira?",
    deleteConfirmFolder: "Mover a pasta {name} e seus {count} arquivo(s) para a lixeira?",
    ...
    trustTitle: "Confiar neste projeto?",
    trustMessage: "O projeto {name} vem de uma pasta externa. Confirme que confia em seu conteúdo antes de abrir ou executar arquivos.",
    trustConfirm: "Confiar e continuar",
    executeFolder: "Executar a pasta inteira",
    executeFolderEmpty: "Nenhum arquivo SQL executável nesta pasta",
    removeProject: "Remover projeto",
    removeProjectConfirm: "Remover o projeto {name} da lista? Os arquivos no disco não serão excluídos.",
    revealActiveFile: "Localizar arquivo ativo",
    noFileToReveal: "Nenhum arquivo SQL aberto para localizar",
    unsavedChanges: "Há alterações não salvas",
    localHistory: "Histórico local",
    localHistoryEmpty: "Ainda não há snapshots do histórico",
    localHistorySelect: "Selecione um snapshot para visualizar",
    localHistoryRestore: "Restaurar",
    localHistoryRestoreConfirm: "Restaurar o snapshot selecionado? O conteúdo atual é salvo primeiro como snapshot, então você pode restaurá-lo novamente a qualquer momento.",
    localHistoryRestored: "Restaurado",
    localHistoryRestoreFailed: "Falha ao restaurar: {message}",
    localHistoryConflict: "O arquivo foi modificado externamente; atualize e tente novamente",
  },
  mqTopics: {
